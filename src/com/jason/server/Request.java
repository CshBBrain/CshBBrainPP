...
public class Request {
	...
	public boolean readFinish(){
		return this.fileReceiver == null ? ((this.dataSizeLeftInt <= 0 ? true : false) && (this.dataSizeLeftLong <= 0 ? true : false)) : ((this.fileReceiver != null && this.fileReceiver.finishWrite()));
	}
	public Request(){
